...
from aum_ssm.ops.triton.unfold.utils import cos_approx, sin_approx, sigmoid_approx
...
@triton.jit
def siso_bwd_kernel_rotary_bias_angles(
    # Input tensors
...
@triton.jit
def siso_bwd_kernel_dk_state_post(
    # Inputs tensors
...
def compute_dqktheta(
    ...
    siso_bwd_kernel_rotary_bias_angles[grid](
        # Input tensors
        q, k, scale, gamma, q_bias, k_bias, angles, dq_in, dk_in, dqk,
        # Output tensors
...
def apply_dk_state_post(
    ...
    siso_bwd_kernel_dk_state_post[grid](
        # Input tensors
...
@triton.jit
def siso_bwd_kernel_ddt_dtrap_dinput_states(
    # Input tensors
...
def compute_ddt_dtrap_dinput_states(
    ...
    siso_bwd_kernel_ddt_dtrap_dinput_states[grid](
        # Inputs
        dscale, dgamma, dt, trap,
