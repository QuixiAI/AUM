...
# Import kernels
from aum_ssm.ops.triton.unfold.siso_fwd import siso_fwd
from aum_ssm.ops.triton.unfold.siso_bwd import compute_dzdo, compute_dqkv, compute_dqktheta, compute_ddt_dtrap_dinput_states
from aum_ssm.ops.triton.unfold.angle_dt import angle_dt_fwd, angle_dt_bwd
...
class _Mamba3Function(torch.autograd.Function):
    ...
    def forward(
        ...
        Out, Out_v, SSM_States, DA_CS, DA_CS_SUM, Q_rot, K_scaled, QK_dot, Scale, Gamma, Final_States = siso_fwd(
