...
#
# AUM-Ø A phase: bounded local GQA grounding (§4). Forked from Mamba's MHA.
# TODO(AUM): (1) windowed/local causal attention (bounded grounding); (2) QK-norm (q_norm/k_norm).
