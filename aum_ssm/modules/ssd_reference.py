...
try:
    # Mamba-2 SSD kernel was removed in the AUM-Ø fork; only the pure-PyTorch reference below
    # (segsum / ssd_minimal_discrete) is needed. The kernel comparison in test_correctness() is N/A.
    from aum_ssm.ops.triton.ssd_combined import mamba_chunk_scan_combined
except ImportError:
